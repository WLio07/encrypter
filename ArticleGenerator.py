...
def module_1(a, b):
    ...
    name_apre = input("What's the name of the anime? ")
    name_scrap = input("Anime/manga no namae wa? ")
    return [a, ] #a is random of adcj_temp
...
def module_2_1():
    a = int(input('Was it: 1 - a license purchase or 2 - a brand new product?'))
    return a
